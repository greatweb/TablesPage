...
public partial class Default3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //lblNo1A.Text = randomizer.Next(1,5).ToString();
        //lblNo2A.Text = randomizer.Next(1,5).ToString();
        //lblNo3A.Text = randomizer.Next(1,5).ToString();
        //lblNo4A.Text = randomizer.Next(1,5).ToString();

        while (randomList.Count < 4)
        {
MyNumber = randomizer.Next(1, 5);
